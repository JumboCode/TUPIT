...
class SearchBox extends Component {
   ...
   */
  renderSearch() {
    const search_default = this.state.search_default;
    ...
    const search_box = (
      <div className={styles.container}>
        <div className={styles.select_box}>
          <select onChange={this.searchQuery} defaultValue={search_default}>
            <option key={search_default} value={search_default} disabled>
              {search_default}
            </option>
            {search_option}
          </select>
